...
const RegistrationPrompt: React.FC<RegistrationPromptProps> = ({
  ...
  const translations = {
    en: {
      ...
      currentSessionDesc:
        "Save your current symptom analysis and get personalized follow-up care",
      features: {
        ...
        items: [
          {
            ...
            description:
              "Get detailed health insights based on your medical history and preferences",
          },
          {
            icon: Shield,
            title: "Secure Medical Records",
            description:
              "HIPAA-compliant storage of your health data with bank-level encryption",
          },
          {
            icon: Clock,
            title: "Health History Tracking",
            description:
              "Monitor symptoms over time and track your health journey",
          },
          {
            icon: Phone,
            title: "Doctor Appointments",
            description:
              "Book appointments with Qatar's top healthcare providers",
          },
          {
            icon: MessageSquare,
          ...
          },
          {
            ...
            description:
              "Family health management, medication reminders, and more",
          },
        ],
      },
      benefits: {
        ...
        items: [
          {
            ...
            description:
              "احصل على رؤى صحية مفصلة بناءً على تاريخك الطبي وتفضيلاتك",
          },
          {
            icon: Shield,
