...
const SymptomAnalysisPublic: React.FC<SymptomAnalysisPublicProps> = ({
  ...
  const translations = {
    en: {
      ...
      confidential:
        "Your data is secure and will be deleted automatically after 24 hours.",
    ...
    ar: {
      ...
      disclaimer:
        "هذا تقييم أولي من الذكاء الاصطناعي ولا يجب أن يحل محل الاستشارة الطبية المتخصصة.",
  ...
  return (
    <div
      className={`max-w-4xl mx-auto p-4 space-y-6 ${isRTL ? "rtl" : "ltr"}`}
      dir={isRTL ? "rtl" : "ltr"}
    >
      ...
      <Card className="shadow-lg">
        <div className="bg-gradient-to-br from-primary-50 to-secondary-50 p-6 rounded-t-lg">
          ...
          <p className="text-neutral-600">{t.analysisSubtitle}</p>
        </div>
        ...
        <div className="p-6 space-y-6">
            ...
            >
              ...
              <p
                className={`text-lg font-bold ${
                  t.severityColors[result.severity]
                }`}
              >
              ...
              <div className="flex items-start mb-3">
                ...
                <div>
                  <p className="font-medium text-secondary-800">
                    {(t.actionLabels as any)[result.recommendations.action] ||
          ...
          <div className="border-t pt-6 space-y-4">
            <div className="text-sm text-neutral-500">
              <p>
                <strong>{t.sessionId}:</strong> {result.sessionId}
              </p>
